...
import QueryPopup from "./Components/Popups/QueryMessagePopup";
...
const Action = () => {
  ...
  const getUserData = async () => {
    ...
    if (docSnap.exists()) {
      ...
      setFirstWitnessRelationshipType(
        docSnap.data().registeredData["firstWitnessRelationshipType"]
      );
      setFirstWitnessPhoneNumber(
        docSnap.data().registeredData["firstWitnessPhoneNumber"]
      );
      setSecondWitnessFullName(
        docSnap.data().registeredData["secondWitnessFullName"]
      );
      setSecondWitnessRelationshipType(
        docSnap.data().registeredData["secondWitnessRelationshipType"]
      );
      setSecondWitnessPhoneNumber(
        docSnap.data().registeredData["secondWitnessPhoneNumber"]
      );
      ...
      setAlternativePhoneNumber(
        docSnap.data().registeredData["alternativePhoneNumber"]
      );
      ...
      setLocalGovernmentArea(
        docSnap.data().registeredData["localGovernmentArea"]
      );
      ...
      setQueryMessage(docSnap.data().queryMessage);
  ...
  return (
    <div className="editAddressPage">
      <section className="editAddress">
        ...
        <div className="form-2">
          <div className="ActionStart">
            ...
            <div className="ActionStartGroup-Prove">
            ...
            <div className="ActionStartGroup">
              <label htmlFor="">Uploded by</label>
              <h4>{uploadedBy}</h4>
            </div>
            <div className="ActionStartGroup">
              <label htmlFor="">Query message</label>
              <h4>{queryMessage ? queryMessage : "Null"}</h4>
            </div>
            <div className="ActionStartGroup">
      ...
      {isLoading ? (
        <div className="actionCenter">Loading...</div>
      ) : (
        <div className="actionCenter">
          ...
          {verifiedStatus ? (
            ...
            <button
              ...
              type="button"
              onClick={() => AddressVerificationStatus("approve")}
            >
              <p>Approve</p>
            </button>
          )}

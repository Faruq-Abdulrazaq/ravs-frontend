...
const View = () => {
    ...
    const getUserData = async () => {
        const docRef = doc(db, "RAVS", userId);
            ...
            if (docSnap.exists()) {
                setFullname(docSnap.data().registeredData['surname'] + " " + docSnap.data().registeredData['othernames'])
        ...
        <div className="displayA4">
            <div className="displayContent">
                <header className="displayContent-header">
                    <img src="https://firebasestorage.googleapis.com/v0/b/ravs-53992.appspot.com/o/Meta%20Image%2FR%20(1).png?alt=media&token=4eacecc3-07d6-4a6a-bf5b-dce874933027" alt="" />
                </header>
                <div className="displayContent-content">
                    ...
                    <div className="content-declaration">
                        <p>This is to certify that the residency details of which are recoded here in has been registered on 
                             <span>{dateTime.getDate()} - {months[dateTime.getMonth()]}  - {dateTime.getFullYear()}</span> at this registration center <span>{center}</span>
                              </p>
                ...
                <div className="accreditation">
                    <h2>Accreditation</h2>
                    <p>We are thrilled to announce that our esteemed organization has been awarded official 
                        accreditation for our highly regarded Certificate of Residency program. This accreditation 
                        serves as a testament to our commitment to excellence and the highest standards of quality in 
                        providing residency verification services.</p>
                   <p className="b-2">Accreditation Body: KNOW YOUR COMMUNITY TECHNOLOGY</p> 
                   <p className="b-2"> Accreditation Status: Accredited   </p>  
                   <p>The Certificate of Residency program has undergone a rigorous evaluation process, ensuring that it adheres to the most 
                    stringent industry guidelines and best practices. The accreditation
                     is a significant achievement that recognizes our dedication to delivering accurate and reliable residency verification for individuals and organizations alike.</p>               
                                                          
                </div>
                <div className="signDate">
                    <div className="sign">
                        <h4>Date: <span>12-03-2020</span> </h4>
                        <h4><span>___________________________</span> <br /> Signature of Registrar </h4>
                    </div>
                    <div className="name">

    ...
    <div className="QueresPage">
      ...
      <section className="mainnav">
        ...
        <div className="queryShow">
          <h3></h3>
          {totalQueried ? (
            <h1 className="h1-address">No Queres</h1>
          ) : (
                ...
                {totalQueried.map((table) => (
                  <tbody key={table._id}>
                    <tr>
                      ...
                      <td>
                        {table.fromDb["registeredData"].localGovernmentArea}
                      </td>
                      ...
                      <td>
                        {table.fromDb["registeredData"].lengthOfResidency}
                      </td>
                      <td>
                        {table.fromDb["registeredData"].firstWitnessFullName}
                      </td>
                      <td>
                        {
                          table.fromDb["registeredData"]
                            .firstWitnessRelationshipType
                        }
                      </td>
                      <td>
                      ...
                      <td>
                        {table.fromDb["registeredData"].secondWitnessFullName}
                      </td>
                      <td>
                        {
                          table.fromDb["registeredData"]
                      ...
                      <td>
                        <Link to={"/edit/" + table._id} target="_blank">

        ...
        <header>
          <div className="info-address">
            <div className="infodetails">
              <span className="info-span-1">
                KYCT ({role}){" "}
                {JSON.parse(localStorage.getItem("RavsAuthUser"))["center"]}
              </span>
              <span className="info-span-2">
                {day}, {date} {month} {year}
              </span>
            </div>
            <form>
              ...
              >
                ...
                <option value="localGovernmentArea">
                  Local Government Area
                </option>
                <option value="homeTown">Home Town</option>
                <option value="occupation">Occupation</option>
                <option value="phoneNumber">Phone Number</option>
                <option value="alternativePhoneNumber">
                ...
                <option value="firstWitnessFullName">
                  First Witness Full Name
                </option>
                <option value="firstWitnessRelationshipType">
                  First Witness Relationship
                </option>
                <option value="firstWitnessPhoneNumber">
                  First Witness Phone Number
                </option>
                <option value="secondWitnessFullName">
                  Second Witness Full Name
                </option>
                <option value="secondWitnessRelationshipType">
                  Second Witness Relationship
                </option>
                <option value="secondWitnessPhoneNumber">
              ...
              >
                <button className="download-table-xls-button">
                  {" "}
                  Export excel{" "}
                </button>
              </DownloadTableExcel>
            ...
            {tables
              .filter((table) => {
                return search.toLowerCase() === ""
                  ? table
                  : table.fromDb["registeredData"][searchFilter]
                      .toLowerCase()
                      .includes(search);
              })
              .map((table) => (
                <tbody key={table._id}>
                  <tr>
                    ...
                    <td>
                      {table.fromDb.registeredData.alternativePhoneNumber}
                    </td>
                    ...
                    <td>
                      {table.fromDb.registeredData.firstWitnessRelationshipType}
                    </td>
                    <td>
                      {table.fromDb.registeredData.firstWitnessPhoneNumber}
                    </td>
                    <td>{table.fromDb.registeredData.secondWitnessFullName}</td>
                    <td>
                      {
                        table.fromDb.registeredData
                          .secondWitnessRelationshipType
                      }
                    </td>
                    <td>
                      {table.fromDb.registeredData.secondWitnessPhoneNumber}
                    </td>
                    ...
                    {role === "Admin" ? (
                      <td>
                        <Link to={"/action/" + table._id} target="_blank">
                          <button className="open">Open</button>
                        </Link>
                        {table.fromDb.verified ? (
                          <Link to={"/" + table._id} target="_blank">
                            <button className="open">Print</button>
                          </Link>
                        ) : (
                          ""
                        )}
                      ...
                      <td>
                        <Link to={""} target="_blank">
                          <button className="open">Edit</button>
                        </Link>
                        {table.fromDb.verified ? (
                          <Link to={"/" + table._id} target="_blank">
                            <button className="open">Print</button>

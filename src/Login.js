...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    await signIn(email, password)
      .then(async (response) => {
        const docRef = doc(db, "UsersRavs", `${response.user.uid}`);
  ...
  return (
    <div className="loginPage">
      <section className="main">
        <img
          src="https://firebasestorage.googleapis.com/v0/b/ravs-53992.appspot.com/o/Meta%20Image%2FKYCT-full-removebg-preview.png?alt=media&token=eb4a289e-e7f6-4aef-8a21-2dcd397c82a6"
          alt=""
        />
        <h4>{error}</h4>

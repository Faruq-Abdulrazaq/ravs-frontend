    ...
    <section className="addAddress">
      ...
      <div className="addAddress-form">
        <div className="form-1">
          <p>
            State of residence and address Infomation * <br />
            (3-5)
          </p>
          <div className="NewAddress">
            <div className="inputGroup">
              ...
              >
                ...
                <option value="One story semi detached Duplex">
                  One story semi detached Duplex
                </option>
                <option value="Room/Let in (Face-me-face-you)">
                  Room/Let in (Face-me-face-you)
                </option>

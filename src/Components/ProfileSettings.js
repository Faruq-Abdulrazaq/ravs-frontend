            ...
            <div className="form-2">
                ...
                <div className="settingsInformation">
                    <div className="inputGroup">
                        <input type="text" autoComplete="off" name="text" placeholder="Full name" />
                    </div>
                    <div className="inputGroup">
                        <input type="email" autoComplete="off" name="text" placeholder="Email address" />
                    </div>
                    <div className="inputGroup">
                        <input type="number" autoComplete="off" name="text" placeholder="Phone number" />
                    </div>
            
                    <div className="inputGroup">
                        <input type="number" autoComplete="off" name="text" placeholder="Altanative phone number" />
                    </div>
                    <div className="inputGroup">
                        <input type="text" autoComplete="off" name="text" placeholder="Address" />
                    </div>
